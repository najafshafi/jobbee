...
const CompanyReviewManagment = () => {
  ...
  return (
    <React.Fragment>
      <Head title="Company Reviews" />
      <Content>
        <div className="d-flex justify-content-between mb-2">
          <BlockHead size="sm">
            <BlockBetween>
              <BlockHeadContent>
                <BlockTitle page>Company Review Managment</BlockTitle>
          ...
          <DataTable className="card-stretch text-center">
            ...
            <DataTableBody>
              <DataTableHead>
                ...
                <DataTableRow>
                  <span className="sub-text p-2">Review ID</span>
                </DataTableRow>
                <DataTableRow size="mb">
                  <span className="sub-text p-2">Review</span>
                </DataTableRow>
                <DataTableRow size="md">
                  <span className="sub-text p-2">Rating</span>
                </DataTableRow>
                ...
                <DataTableRow size="lg">
                  <span className="sub-text p-2">Status</span>
                </DataTableRow>
              </DataTableHead>
              {/*Head*/}
                      ...
                      <DataTableItem key={item._id}>
                        ...
                        */}
                        ...
                        <DataTableRow size="md">
                          ...
                          <Link to="/review-managment/company-review/details">
                            <span className="text-azure text-decoration-underline">
                              that employee is good our company was good
                            </span>
                          </Link>
                        </DataTableRow>
                        <DataTableRow size="mb">
                          <span className="text-azure text-decoration-underline">User ID</span>
                        </DataTableRow>
                        <DataTableRow size="mb">
...
export default CompanyReviewManagment;
