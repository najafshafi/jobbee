            ...
            <DataTableBody>
              <DataTableHead>
                ...
                <DataTableRow size="md">
                  <span className="sub-text p-2">Phone number</span>
                </DataTableRow>
                <DataTableRow size="lg">
                  <span className="sub-text p-2">Maching request</span>
                </DataTableRow>
                <DataTableRow size="lg">
                  <span className="sub-text p-2">Date of matched</span>
                </DataTableRow>
                <DataTableRow size="lg">
                  <span className="sub-text p-2">Name(ID)</span>
                </DataTableRow>
                <DataTableRow size="lg">
                  <span className="sub-text p-2">accepted status</span>
                </DataTableRow>
                <DataTableRow size="lg">
                  <span className="sub-text p-2">Current status</span>
                </DataTableRow>
                <DataTableRow size="lg">
                  <span className="sub-text p-2">Push Alarm</span>
                </DataTableRow>
                <DataTableRow size="lg">
                  <span className="sub-text p-2">detail </span>
                </DataTableRow>
              </DataTableHead>
              {/*Head*/}
                      ...
                      <DataTableItem key={item._id}>
                        ...
                        */}
                        ...
                        <DataTableRow size="mb">
                          <Link to="#">
                            {" "}
                            <span className="text-azure text-decoration-underline">JohnSwith</span>
                          </Link>
                        </DataTableRow>
                        <DataTableRow size="mb">
                          <span>pending</span>
                        ...
                        <DataTableRow size="mb">
                          <Link to="#">
                            {" "}
                            <span className="text-azure text-decoration-underline">send</span>
                          </Link>
                        </DataTableRow>
                        <DataTableRow size="mb">
                          <Link to={`${process.env.PUBLIC_URL}/matching-managment/details`}>
                            <span className="text-azure text-decoration-underline">Open</span>
                          </Link>
                        </DataTableRow>
                      </DataTableItem>
                    );
...
export default MatchingManagment;
